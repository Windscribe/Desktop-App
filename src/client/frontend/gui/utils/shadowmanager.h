...
class ShadowManager : public QObject
{
    Q_OBJECT
public:
    enum SHAPE_ID { SHAPE_ID_INVALID = -1, SHAPE_ID_LOCATIONS, SHAPE_ID_CONNECT_WINDOW, SHAPE_ID_WELCOME_WINDOW,
                    SHAPE_ID_SIGNUP_WINDOW, SHAPE_ID_PREFERENCES, SHAPE_ID_BOTTOM_INFO, SHAPE_ID_UPDATE_WIDGET,
                    SHAPE_ID_INIT_WINDOW, SHAPE_ID_NEWS_FEED, SHAPE_ID_PROTOCOL, SHAPE_ID_GENERAL_MESSAGE, SHAPE_ID_EXIT };
