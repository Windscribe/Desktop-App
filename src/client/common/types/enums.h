...
enum CONNECT_ERROR  {
    ...
    CONNECTION_BLOCKED,
    NO_OPENVPN_SOCKET,
    EXE_SUBPROCESS_FAILED,
    NO_INSTALLED_TUN_TAP,
    UDP_CANT_ASSIGN,
    CONNECTED_ERROR,
    INITIALIZATION_SEQUENCE_COMPLETED_WITH_ERRORS,
    UDP_NO_BUFFER_SPACE,
    UDP_NETWORK_DOWN,
    TCP_ERROR,
    CANNOT_OPEN_CUSTOM_CONFIG,
    IKEV_FAILED_TO_CONNECT,
    IKEV_NOT_FOUND_WIN,
    IKEV_FAILED_SET_ENTRY_WIN,
    IKEV_FAILED_MODIFY_HOSTS_WIN,
    ...
    WIREGUARD_FAILED_START_MAC,
    WIREGUARD_CONNECTION_ERROR,
    WIREGUARD_SYSTEMEXTENSION_INACTIVE,
    EMERGENCY_FAILED_CONNECT,
    WINTUN_OVER_CAPACITY,
    WINTUN_FATAL_ERROR,
    WIREGUARD_ADAPTER_SETUP_FAILED,
    WIREGUARD_COULD_NOT_RETRIEVE_CONFIG,
    CTRLD_START_FAILED,
    PRIV_KEY_PASSWORD_ERROR,
    LOCKDOWN_MODE_IKEV2,
    LOCAL_DNS_SERVER_NOT_AVAILABLE
};
