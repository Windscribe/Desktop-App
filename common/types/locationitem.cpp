...
QVector<LocationItem> LocationItem::loadLocationsFromJson(const QByteArray &arr)
{
    QVector<LocationItem> locations;
...
LocationItem LocationItem::loadLocationFromJson(const QByteArray &arr)
{
    QJsonDocument doc = QJsonDocument::fromJson(arr);
    Q_ASSERT(doc.isObject());
...
LocationItem LocationItem::locationFromJsonObject(const QJsonObject &obj)
{
