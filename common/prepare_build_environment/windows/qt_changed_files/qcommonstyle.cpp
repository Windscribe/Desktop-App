                                                 ...
                                                 const QPoint &pt, const QWidget *widget) const
{
    ...
    case CC_ScrollBar:
	    ...
	    // fixed bug for scrollbar (AzanovAA)
	    QVector<uint> enumTypes;
	    enumTypes.reserve(8);
	    enumTypes << SC_ScrollBarSlider << SC_ScrollBarAddLine << SC_ScrollBarSubLine << SC_ScrollBarAddPage << SC_ScrollBarSubPage << SC_ScrollBarFirst << SC_ScrollBarLast << SC_ScrollBarGroove;
            int ind = 0;

            uint ctrl = enumTypes[ind];
	    Q_FOREACH(uint ctrl, enumTypes)
            {
