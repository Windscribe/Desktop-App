...
SearchWidgetLocations::SearchWidgetLocations(QWidget *parent) : QAbstractScrollArea(parent),
    width_(0),
    height_(0),
    topInd_(0),
    topOffs_(0),
...
void SearchWidgetLocations::setExpanded(bool bExpanded)
{
...
QPoint SearchWidgetLocations::adjustToolTipPosition(const QPoint &globalPoint, const QSize &toolTipSize, bool isP2PToolTip)
{
...
QPoint SearchWidgetLocations::getSelectItemConnectionMeterCenter()
{
