...
std::string to_string(HttpReply::status_type status)
{
  ...
  case HttpReply::not_found:
    return not_found;
  case HttpReply::too_many_requests:
...
HttpReply HttpReply::stock_reply(HttpReply::status_type status)
{
  ...
  // windscribe headers
  rep.headers[2].name = "Access-Control-Allow-Credentials";
  rep.headers[2].value = "true";

  rep.headers[3].name = "Access-Control-Allow-Headers";
  rep.headers[3].value = "*";

  rep.headers[4].name = "Access-Control-Allow-Methods";
  rep.headers[4].value = "POST, GET, OPTIONS";

  rep.headers[5].name = "Access-Control-Allow-Origin";
  rep.headers[5].value = "https://windscribe.com";
