...
- (void)drawImage:(NSImage *)image withFrame:(NSRect)frame inView:(NSView *)controlView
{
    ...
    if (self.isHighlighted && self.isEnabled)
        [image drawInRect:rc fromRect:NSZeroRect operation:NSCompositingOperationSourceOver fraction:0.9];
    else if (button.isHovering && self.isEnabled)
        [image drawInRect:rc fromRect:NSZeroRect operation:NSCompositingOperationSourceOver fraction:0.8];
    else
        [image drawInRect:rc fromRect:NSZeroRect operation:NSCompositingOperationSourceOver fraction:0.5];
}
@end
...
- (void)drawImage:(NSImage *)image withFrame:(NSRect)frame inView:(NSView *)controlView
{
    ...
    [image drawInRect:rcImage fromRect:NSZeroRect operation:NSCompositingOperationSourceOver fraction:fraction respectFlipped:flipped hints:nil];
}
