...
#define PAR_DYNAMIC_DOMAIN_CLOUDFLARE_URL1  300     // https://1.1.1.1/dns-query
#define PAR_DYNAMIC_DOMAIN_CLOUDFLARE_URL2  301     // https://1.0.0.1/dns-query
#define PAR_DYNAMIC_DOMAIN_CLOUDFLARE_URL3  302     // https://cloudflare-dns.com/dns-query
#define PAR_DYNAMIC_DOMAIN_GOOGLE_URL1   	303     // https://8.8.8.8/resolve
#define PAR_DYNAMIC_DOMAIN_GOOGLE_URL2   	304     // https://8.8.4.4/resolve
#define PAR_DYNAMIC_DOMAIN_GOOGLE_URL3   	305     // https://dns.google/resolve
...
#define PAR_ECH_CONFIG_DOMAIN				800		// echconfig001.windscribe.dev
#define PAR_ECH_DOMAIN						900		// ech-public-test.windscribe.dev
