...
enum LOGIN_RET {
    ...
    LOGIN_RET_SSL_ERROR = 5,
    LOGIN_RET_BAD_CODE2FA = 6,
    LOGIN_RET_MISSING_CODE2FA = 7,
    LOGIN_RET_ACCOUNT_DISABLED = 8,
    LOGIN_RET_SESSION_INVALID = 9,
    LOGIN_RET_RATE_LIMITED = 10,
};
...
enum CONNECT_ERROR  {
  ...
  WIREGUARD_COULD_NOT_RETRIEVE_CONFIG = 42,
  CTRLD_START_FAILED = 43,
  PRIV_KEY_PASSWORD_ERROR = 44,
  LOCKDOWN_MODE_IKEV2 = 45,
};
