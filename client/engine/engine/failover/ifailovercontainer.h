...
public:
    ...
    virtual QSharedPointer<BaseFailover> currentFailover(int *outInd = nullptr) = 0;
    ...
    virtual QSharedPointer<BaseFailover> failoverById(const QString &failoverUniqueId) = 0;
