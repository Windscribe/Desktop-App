    ...
    requestTimer_(this)
{
    ...
    connect(networkAccessManager_, &NetworkAccessManager::whitelistIpsChanged, [this] (const QSet<QString> &ips) {
        //FIXME:
        QStringList list(ips.begin(), ips.end());
        emit hostIpsChanged(list);
    });
