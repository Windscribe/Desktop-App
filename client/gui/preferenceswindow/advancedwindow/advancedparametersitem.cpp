  ...
  , saved_(false)
{
    ...
    connect(textEdit_, &CustomTextEditWidget::textChanged, this, &AdvancedParametersItem::onTextEditTextChanged);
    ...
    connect(clearButton_, &CommonGraphics::BubbleButtonDark::clicked, this, &AdvancedParametersItem::onClearClicked);
    ...
    connect(saveButton_, &CommonGraphics::BubbleButtonBright::clicked, this, &AdvancedParametersItem::onSaveClicked);

    connect(&LanguageController::instance(), &LanguageController::languageChanged, this, &AdvancedParametersItem::onLanguageChanged);

    connect(this, &AdvancedParametersItem::heightChanged, this, &AdvancedParametersItem::onHeightChanged);
    ...
    connect(&saveTextColorAnimation_, &QVariantAnimation::valueChanged, this, &AdvancedParametersItem::onSaveTextColorChanged);
    connect (&saveFillOpacityAnimation_, &QVariantAnimation::valueChanged, this, &AdvancedParametersItem::onSaveFillOpacityChanged);
}
