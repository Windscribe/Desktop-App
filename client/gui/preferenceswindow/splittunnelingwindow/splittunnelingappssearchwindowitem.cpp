    ...
    , preferences_(preferences)
{
    ...
    connect(splitTunnelingAppsSearchItem_, SIGNAL(appsUpdated(QList<types::SplitTunnelingApp>)), SLOT(onAppsUpdated(QList<types::SplitTunnelingApp>)));
...
QList<types::SplitTunnelingApp> SplitTunnelingAppsSearchWindowItem::getApps()
{
    return splitTunnelingAppsSearchItem_->getApps();
}

void SplitTunnelingAppsSearchWindowItem::setApps(QList<types::SplitTunnelingApp> apps)
{
...
void SplitTunnelingAppsSearchWindowItem::onAppsUpdated(QList<types::SplitTunnelingApp> apps)
{
